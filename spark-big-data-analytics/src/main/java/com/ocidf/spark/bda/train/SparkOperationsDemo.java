...
import com.ocidf.spark.bda.common.DataResource;
...
public class SparkOperationsDemo {
	...
	public static void main(String[] args) {
		...
		// Criar RDD a partir de uma lista
		...
		// Crie um RDD a partir de um arquivo
		...
		// RDDs também podem ser convertidos novamente em Java Lists com collect (). Então
		// As listas Java podem ser armazenadas usando qualquer coletor de dados e qualquer técnica
		// disponível no Java padrão.
		...
		// Filter Example : Filter data for only "mazda" with inline lambda
		// function
		JavaRDD<String> mazdaData 
            = autoData.filter(str -> str.contains("mazda"));
		System.out.println("Spark Operations : FILTER");
		ExerciseUtils.printStringRDD(mazdaData, 10);
		...
		JavaRDD<String> words 
            = mazdaData.flatMap(new FlatMapFunction<String, String>() {
		...
		System.out.println("mazda words count :" + words.count());
